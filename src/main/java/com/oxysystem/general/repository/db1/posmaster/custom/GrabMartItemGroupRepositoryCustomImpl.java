...
@Repository
public class GrabMartItemGroupRepositoryCustomImpl implements GrabMartItemGroupRepositoryCustom {
    @PersistenceContext(unitName = "db1")
    private EntityManager entityManager;

    @Override
    public List<GrabMartItemGroupViewDTO> getGrabMartItemGroups(String name) {
        ...
        return results.stream().map(r -> new GrabMartItemGroupViewDTO(
