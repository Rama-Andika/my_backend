...
public class UploadSalesMartScheduler {
    ...
    public UploadSalesMartScheduler(GrabMartOrderSyncServiceImpl orderSyncService, GrabMartOrderSyncPartnerServiceImpl orderSyncPartnerService, SalesService salesService, GrabMartOAuthServiceImpl oAuthService, StrukKasirService strukKasirService, StockService stockService, @Qualifier("uploadSalesGrabMartScheduler") Scheduler scheduler) {
